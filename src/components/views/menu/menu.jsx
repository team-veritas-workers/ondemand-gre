...
const Menu = (props) => {
	//here I am checking every single video against the progress array
	//to see what has been watched. Then I assign a length property if it has been watched
